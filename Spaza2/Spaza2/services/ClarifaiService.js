    ...
    const USER_ID = 'islajust';
    // Your PAT (Personal Access Token) can be found in the portal under Authentification
    const PAT = '72bffe5157af492ab1db7c00a8e0b618';
    const APP_ID = 'spaza';
    // Change these to whatever model and image input you want to useconst WORKFLOW_ID = 'visual-text-recognition-id';
